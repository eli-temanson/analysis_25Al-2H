...
void cs_corr() {
    ...
    auto c2s_hamill_low = new TLine(0.09, 0, 0.09, 9);
    c2s_hamill_low->SetLineStyle(7);
    c2s_hamill_low->SetLineWidth(2);
    c2s_hamill_low->SetLineColor(8);
    c2s_hamill_low->Draw();

    auto c2s_hamill_high = new TLine(0.13, 0, 0.13, 9);
    c2s_hamill_high->SetLineStyle(7);
    c2s_hamill_high->SetLineWidth(2);
    c2s_hamill_high->SetLineColor(8);
    c2s_hamill_high->Draw();
    
    auto c2s_hamill = new TLine(0.11, 0, 0.11, 9);
    c2s_hamill->SetLineColor(8);
    c2s_hamill->SetLineWidth(2);
    c2s_hamill->Draw();
    ...
    cross_section_high->SetLineWidth(2); 
    ...
    legend->AddEntry(c2s_hamill,"C^{2}S's from Hamill et. al, ^{26}Mg","l");
